            ...
            for (var item of CartItem) {
                if (item == d.id) {
                    ...
                    document.getElementById('cartab' + d.id).innerHTML = '<tr><th><h3 id="name' + d.id +
                        '">Name :</h3></th></tr ><tr><th><h3 id="price' + d.id + '">Price :</h3></th></tr><tr><th><h3 id="brand' + d.id + '">Brand :</h3></th></tr><tr><td><input type="button" id="' + d.id + '" class="btn btn-danger remove" value="Remove"   onClick="removeProductCart()"/></td><td><input type="button" class="btn btn-success success" value="Buy Now" onClick="buyNow()" /></td></tr>'
...
function removeProductCart() {
    ...
    localStorage.setItem("AddCart",removeCart);
